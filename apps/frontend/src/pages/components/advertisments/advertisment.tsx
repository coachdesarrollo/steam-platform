...
export function Advertisement({
  ...
  return (
    <article className="border-y-zinc-800 grid grid-cols-1 gap-x-0 gap-y-16 border-y-4 px-12 py-16 text-center lg:grid-cols-2 lg:gap-x-10 lg:text-left">
      <section
      ...
      <section
        className={`text-white flex animate-slide flex-col justify-center [animation-range:cover_cover_500px] [animation-timeline:view()] ${
          reverse ? `translate-x-full lg:order-first` : `-translate-x-full`
        }`}
      >
