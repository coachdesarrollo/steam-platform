...
function PaymentSelection() {
  ...
  return (
    ...
    <div className="w-[480px] items-center justify-center gap-7 space-y-8 bg-black/60 p-6 pt-5 max-sm:flex max-sm:h-screen max-sm:min-h-screen max-sm:w-screen max-sm:flex-col max-sm:items-center max-sm:justify-center max-sm:space-y-2 max-sm:bg-[#0000007c]">
