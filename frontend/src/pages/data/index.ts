...
import { autoIncrementIdGenerator, getNumericId, getUUID } from "@/common/utils/generator";
...
export const faq: Array<Faq> = [
  {
    ...
    answer:
      " Nuestra plataforma se distingue por su avanzada gamificación, que incluye logros, insignias, y un sistema de puntos que los estudiantes pueden usar para desbloquear contenido exclusivo.",
  },
  {
    id: getUUID(),
    question: "¿Cómo asegura la plataforma que la UI sea la mejor?",
    answer:
      "Trabajamos con diseñadores de UI y UX de primer nivel y realizamos pruebas de usuario exhaustivas para asegurarnos de que cada elemento de la plataforma sea intuitivo y fácil de usar. También utilizamos tecnologías de vanguardia y seguimos las últimas tendencias en diseño para mantenernos al dia.",
  },
  {
    id: getUUID(),
    question: "¿Qué tipo de contenido educativo ofrece la plataforma?",
    answer:
      "Ofrecemos una amplia gama de contenido educativo que abarca desde materias escolares básicas hasta cursos avanzados en tecnología, ciencia, arte, y más. Cada curso está diseñado para ser interactivo y está acompañado de elementos gamificados que hacen que el aprendizaje sea más dinámico y efectivo.",
  },
  {
    id: getUUID(),
    question: "¿Cómo integra la gamificación en el proceso de aprendizaje?",
    answer:
      "La gamificación se integra a través de desafíos interactivos, quizzes, reconocimiento de voz y misiones que los estudiantes deben completar para avanzar. Los estudiantes ganan puntos y recompensas por sus logros, lo que los motiva a seguir aprendiendo y les proporciona un sentido de progreso y competencia sana.",
  },
  {
    id: getUUID(),
    question: "¿Qué tipo de contenido educativo ofrece la plataforma?",
