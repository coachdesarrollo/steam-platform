...
export function Hero() {
  ...
  return (
    <article
      className={`flex h-full animate-fade-out flex-col items-center justify-end px-8 pb-20 text-center text-white [animation-range:exit_-200px] [animation-timeline:view()]`}
    >
