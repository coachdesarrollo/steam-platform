...
export function NavBar() {
    return (
        <nav className="bg-[#070707]">
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                <a href="#" className="flex items-center space-x-3 rtl:space-x-reverse">
                    <img src={lightlogo} className="h-9" alt="steam" />
                </a>
                {/* botón de hamburguesa para dispositivos pequeños */}
                <button data-collapse-toggle="navbar-multi-level" type="button" className="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-white/80 rounded-lg md:hidden hover:bg-[#272727] focus:outline-none focus:ring-1 focus:ring-gray-400 " aria-controls="navbar-multi-level" aria-expanded="false">
...
<nav className="bg-white border-gray-200 dark:bg-gray-900 dark:border-gray-700">
  <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
    <a href="#" class="flex items-center space-x-3 rtl:space-x-reverse">
        <img src={lightlogo} class="h-8" alt="Flowbite Logo" />
    </a>
