	...
	return (
      ...
      <div //Footer title container
        ...
        className="flex justify-center "> 
          ...
          <a href="https://co.linkedin.com/company/steamacademyco" target="" className="me-6 [&>svg]:h-4 [&>svg]:w-4 hover:dark:text-gray-200">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="currentColor"
              viewBox="0 0 448 512">
      ...
      className="mx-6 py-10 text-center md:text-left ">
        <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          >
            ...
            <a href="#!" className="flex items-center justify-center md:justify-start hover:dark:text-gray-200">
              <span className="me-3 [&>svg]:h-5 [&>svg]:w-5">
              <MobileIcon className="text-gray-400 hover:dark:text-gray-200"/>
