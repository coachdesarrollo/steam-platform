	...
	return (
      ...
      <div //Footer title container
        ...
        className="flex justify-center "> 
          <a href="https://www.facebook.com/STEAMAcademy.co" target="_blank" className="me-6 [&>svg]:h-4 [&>svg]:w-4 hover:dark:text-gray-200">
            <svg
          ...
          <a href="#!" className="me-6 [&>svg]:h-4 [&>svg]:w-4 hover:dark:text-gray-200">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="currentColor"
              viewBox="0 0 512 512">
          ...
          <a href="https://www.instagram.com/steamacademy.co/" target="_blank" className="me-6 [&>svg]:h-4 [&>svg]:w-4 hover:dark:text-gray-200">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="currentColor"
              viewBox="0 0 448 512">
          ...
          <a href="https://co.linkedin.com/company/steamacademyco" target="_blank" className="me-6 [&>svg]:h-4 [&>svg]:w-4 hover:dark:text-gray-200">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="currentColor"
              viewBox="0 0 448 512">
          ...
          <a href="#!" className="[&>svg]:h-4 [&>svg]:w-4 hover:dark:text-gray-200">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="currentColor"
              viewBox="0 0 496 512">
      ...
      className="mx-6 py-10 text-center md:text-left ">
        <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          className="">
            ...
            <p className="mb-4 hover:dark:text-gray-200">
              <a href="https://www.steamacademy.com.co/blog" target="_blank"> Blog </a>
            </p>
          </div>
          ...
          >
            ...
            <a href="#!" className=" group flex items-center justify-center md:justify-start ">
              <span className="me-3 [&>svg]:h-5 [&>svg]:w-5 ">
              <MobileIcon className="text-gray-400 group-hover:dark:text-gray-200"/>
            
              </span>
              <span className="group-hover:text-gray-200">+57 3042801825</span>
