...
import { Step } from "../../../pages/Register/propTypes.d";

const PersonalData: FC<PersonalDataProps> = ({ handleStep }) => {
  return (
    <main className="grid place-content-center h-screen bg-banner-hero bg-no-repeat bg-cover bg-center bg-black/70 bg-blend-multiply">
      <form
        className="bg-black gap-6 px-12 py-8 w-[480px] relative grid"
        autoComplete="off"
        autoCapitalize="sentences"
      >
        <div className=" w-full grid place-content-center">
          <span className="text-white/50 text-center text-sm">1 de 4</span>
        ...
        <Button
          ...
          onClick={() => handleStep(Step.ACCESS_CREDENTIALS)}
        >
          Continuar
        </Button>
      </form>
