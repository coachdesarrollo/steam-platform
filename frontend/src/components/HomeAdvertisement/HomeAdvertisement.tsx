...
const HomeAdvertisement: React.FC<HomeAdvertisementProps> = ({
  ...
  return (
    <article className="flex flex-wrap-reverse lg:grid place-content-center text-center px-12 lg:px-18 xl:px-18 py-16 lg:grid-cols-2 lg:text-left border-y-4 gap-x-0 lg:gap-x-10 gap-y-16 border-y-zinc-800">
      ...
      <section className="flex flex-col justify-center text-white">
        <h2 className="text-3xl lg:text-5xl/snug 2xl:text-6xl font-bold mb-3 text-center">
          {title}
        </h2>
